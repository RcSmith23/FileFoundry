...
class DrawingsControllerTest < ActionController::TestCase
  ...
  test "should create drawing" do
    assert_difference('Drawing.count') do
      post :create, drawing: { description: @drawing.description, name: @drawing.name, res: @drawing.res, upload: @drawing.upload }
    end
  ...
  test "should update drawing" do
    patch :update, id: @drawing, drawing: { description: @drawing.description, name: @drawing.name, res: @drawing.res, upload: @drawing.upload }
    assert_redirected_to drawing_path(assigns(:drawing))
  end
